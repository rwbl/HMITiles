...
#Region Class Header
' File:			ESP32BLELED
' Brief:		Android client controlling an LED connected to an ESP32 via BLE Gatt Manager using commands.
' Date:			202601-06
...
' Libraries:	BleGattManager 1.00, Phone 2.60, RunTimePermissions 1.20, HMITiles 1.40, ByteConverter 1.10
#End Region
