 ...
 *				Wrapped from the library ESP32Servo (http://madhephaestus.github.io/ESP32Servo/annotated.html).
 * Author:		Robert W.B. Linn.
 * Date:		2026-04-13
 * License:		MIT - Copyright © 2025-2026 Robert W.B. Linn. All rights reserved.
 * Notes:		Functions not wrapped:
 *				void setPeriodHertz(int Hertz);
 *              Ensure to install the ESP32Servo library in the Arduino IDE.
 */
