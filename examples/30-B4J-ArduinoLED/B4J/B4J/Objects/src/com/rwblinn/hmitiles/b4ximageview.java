...
public class b4ximageview extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.b4ximageview", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.b4ximageview.class).invoke(this, new Object[] {null});
        else
...
public String  _load(String _dir,String _filename) throws Exception{
 ...
 //BA.debugLineNum = 114;BA.debugLine="setBitmap(xui.LoadBitmap(Dir, FileName))";
...
__c.LogImpl("953936155","Invalid resize mode: "+_mresizemode,0);
 break; }
}
;
...
_mbase.SetColorAndBorder(_mbackgroundcolor,0,(int) (0),_mcornersradius);
 ...
 //BA.debugLineNum = 142;BA.debugLine="Dim jo As JavaObject = mBase";
...
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_mbase.getObject()));
 //BA.debugLineNum = 143;BA.debugLine="Dim shape As JavaObject";
_shape = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 144;BA.debugLine="If mRound Then";
if (_mround) { 
 //BA.debugLineNum = 145;BA.debugLine="Dim radius As Double = Min(mBase.Width / 2, mBas";
_radius = __c.Min(_mbase.getWidth()/(double)2,_mbase.getHeight()/(double)2);
 //BA.debugLineNum = 146;BA.debugLine="Dim cx As Double = mBase.Width / 2";
_cx = _mbase.getWidth()/(double)2;
 //BA.debugLineNum = 147;BA.debugLine="Dim cy As Double = mBase.Height / 2";
_cy = _mbase.getHeight()/(double)2;
 //BA.debugLineNum = 148;BA.debugLine="shape.InitializeNewInstance(\"javafx.scene.shape.";
_shape.InitializeNewInstance("javafx.scene.shape.Circle",new Object[]{(Object)(_cx),(Object)(_cy),(Object)(_radius)});
 }else {
 //BA.debugLineNum = 150;BA.debugLine="Dim cx As Double = mBase.Width";
_cx = _mbase.getWidth();
 //BA.debugLineNum = 151;BA.debugLine="Dim cy As Double = mBase.Height";
_cy = _mbase.getHeight();
 //BA.debugLineNum = 152;BA.debugLine="shape.InitializeNewInstance(\"javafx.scene.shape.";
_shape.InitializeNewInstance("javafx.scene.shape.Rectangle",new Object[]{(Object)(_cx),(Object)(_cy)});
 //BA.debugLineNum = 153;BA.debugLine="If mCornersRadius > 0 Then";
if (_mcornersradius>0) { 
 //BA.debugLineNum = 154;BA.debugLine="Dim d As Double = mCornersRadius";
_d = _mcornersradius;
 //BA.debugLineNum = 155;BA.debugLine="shape.RunMethod(\"setArcHeight\", Array(d))";
_shape.RunMethod("setArcHeight",new Object[]{(Object)(_d)});
 //BA.debugLineNum = 156;BA.debugLine="shape.RunMethod(\"setArcWidth\", Array(d))";
_shape.RunMethod("setArcWidth",new Object[]{(Object)(_d)});
 };
 };
 //BA.debugLineNum = 159;BA.debugLine="jo.RunMethod(\"setClip\", Array(shape))";
