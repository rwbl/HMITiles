...
public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.hmitileutils", null);
		ba.loadHtSubs(hmitileutils.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "com.rwblinn.hmitiles.hmitileutils", ba);
		}
	}
...
public static com.rwblinn.hmitiles.hmitilegridhelper _hmitilegrid = null;
...
public ResumableSub_ChangeButtonTextAnimated(com.rwblinn.hmitiles.hmitileutils parent,anywheresoftware.b4a.objects.B4XViewWrapper _target,String _newtext) {
this.parent = parent;
this._target = _target;
this._newtext = _newtext;
}
com.rwblinn.hmitiles.hmitileutils parent;
...
_hmitilegrid = new com.rwblinn.hmitiles.hmitilegridhelper();
