...
public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.main", null);
		ba.loadHtSubs(main.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "com.rwblinn.hmitiles.main", ba);
		}
	}
    ...
    public void start (javafx.stage.Stage stage) {
        try {
            ...
            frm.initWithStage(ba, stage, 790, 600);
...
_pagesmanager = new com.rwblinn.hmitiles.b4xpagesmanager();
...
_b4xpages._delegate /*com.rwblinn.hmitiles.b4xpagesdelegator*/ ._mainform_closed /*String*/ ();
...
_b4xpages._delegate /*com.rwblinn.hmitiles.b4xpagesdelegator*/ ._mainform_closerequest /*String*/ (_eventdata);
...
_b4xpages._delegate /*com.rwblinn.hmitiles.b4xpagesdelegator*/ ._mainform_focuschanged /*String*/ (_hasfocus);
...
_b4xpages._delegate /*com.rwblinn.hmitiles.b4xpagesdelegator*/ ._mainform_iconifiedchanged /*String*/ (_iconified);
...
_b4xpages._delegate /*com.rwblinn.hmitiles.b4xpagesdelegator*/ ._mainform_resize /*String*/ (_width,_height);
