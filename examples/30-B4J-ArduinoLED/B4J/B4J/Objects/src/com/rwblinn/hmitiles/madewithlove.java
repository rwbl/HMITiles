...
public class madewithlove extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.madewithlove", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.madewithlove.class).invoke(this, new Object[] {null});
        else
...
_tf._append /*com.rwblinn.hmitiles.b4jtextflow*/ ("Made with ");
 //BA.debugLineNum = 23;BA.debugLine="tf.SetFont(xlbl.Font)";
_tf._setfont /*com.rwblinn.hmitiles.b4jtextflow*/ ((anywheresoftware.b4j.objects.JFX.FontWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.objects.JFX.FontWrapper(), (javafx.scene.text.Font)(_xlbl.getFont().getObject())));
 //BA.debugLineNum = 24;BA.debugLine="tf.SetColor(xlbl.TextColor)";
_tf._setcolor /*com.rwblinn.hmitiles.b4jtextflow*/ (_xlbl.getTextColor());
 //BA.debugLineNum = 25;BA.debugLine="tf.Append(Chr(0xF004))";
_tf._append /*com.rwblinn.hmitiles.b4jtextflow*/ (BA.ObjectToString(__c.Chr(((int)0xf004))));
 //BA.debugLineNum = 26;BA.debugLine="tf.SetFont(xui.CreateFontAwesome(xlbl.TextSize))";
_tf._setfont /*com.rwblinn.hmitiles.b4jtextflow*/ ((anywheresoftware.b4j.objects.JFX.FontWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.objects.JFX.FontWrapper(), (javafx.scene.text.Font)(_xui.CreateFontAwesome((float) (_xlbl.getTextSize())).getObject())));
 //BA.debugLineNum = 27;BA.debugLine="tf.SetColor(xui.Color_Red)";
_tf._setcolor /*com.rwblinn.hmitiles.b4jtextflow*/ (_xui.Color_Red);
 //BA.debugLineNum = 28;BA.debugLine="tf.Append(\" in B4X\")";
_tf._append /*com.rwblinn.hmitiles.b4jtextflow*/ (" in B4X");
