...
public class roundslider extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.roundslider", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.roundslider.class).invoke(this, new Object[] {null});
        else
...
public String  _pnl_mouseclicked(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 161;BA.debugLine="Private Sub pnl_MouseClicked(EventData As MouseEve";
...
public String  _pnl_mousepressed(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 157;BA.debugLine="Private Sub pnl_MousePressed (EventData As MouseEv";
 //BA.debugLineNum = 158;BA.debugLine="EventData.Consume";
_eventdata.Consume();
...
public String  _pnl_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 165;BA.debugLine="Private Sub pnl_MouseReleased(EventData As MouseEv";
 //BA.debugLineNum = 166;BA.debugLine="EventData.Consume";
_eventdata.Consume();
