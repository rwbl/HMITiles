...
public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.xuiviewsutils", null);
		ba.loadHtSubs(xuiviewsutils.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "com.rwblinn.hmitiles.xuiviewsutils", ba);
		}
	}
...
public static com.rwblinn.hmitiles.b4ximageview  _createb4ximageview() throws Exception{
com.rwblinn.hmitiles.b4ximageview _iv = null;
...
_iv = new com.rwblinn.hmitiles.b4ximageview();
