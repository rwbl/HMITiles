...
public class b4xradiobutton extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.b4xradiobutton", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.b4xradiobutton.class).invoke(this, new Object[] {null});
        else
...
_iv.SetLayoutAnimated((int) (0),_gap,_gap,_size-2*_gap,_size-2*_gap);
 //BA.debugLineNum = 72;BA.debugLine="pnl.SetLayoutAnimated(0, 0, 0, Width1, Height1)";
_pnl.SetLayoutAnimated((int) (0),0,0,_width1,_height1);
 //BA.debugLineNum = 73;BA.debugLine="mLabel.SetLayoutAnimated(0, Size + gap, 0, Width1";
_mlabel.SetLayoutAnimated((int) (0),_size+_gap,0,_width1-_size-_gap,_height1);
...
_mbase.AddView((javafx.scene.Node)(_iv.getObject()),0,0,0,0);
...
_mbase.AddView((javafx.scene.Node)(_mlabel.getObject()),0,0,0,0);
...
public String  _pnl_mouseclicked(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 83;BA.debugLine="Private Sub Pnl_MouseClicked (EventData As MouseEv";
 //BA.debugLineNum = 84;BA.debugLine="EventData.Consume";
_eventdata.Consume();
...
_xuiviewsutils._settextorcsbuildertolabel /*String*/ (_mlabel,_t);
...
public ResumableSub_SetValueImpl(com.rwblinn.hmitiles.b4xradiobutton parent,boolean _b,boolean _immediate) {
this.parent = parent;
this._b = _b;
this._immediate = _immediate;
}
com.rwblinn.hmitiles.b4xradiobutton parent;
boolean _b;
boolean _immediate;
int _i = 0;
anywheresoftware.b4a.objects.B4XViewWrapper _v = null;
com.rwblinn.hmitiles.b4xradiobutton _rb = null;
int _myindex = 0;
long _start = 0L;
int _duration = 0;
float _state1 = 0f;
...
//if
this.state = 10;
if ((_v).equals(parent._mbase) == false && _v.getTag() instanceof com.rwblinn.hmitiles.b4xradiobutton) { 
this.state = 9;
}if (true) break;
...
_rb = (com.rwblinn.hmitiles.b4xradiobutton)(_v.getTag());
...
parent._xuiviewsutils._setalpha /*String*/ (parent._mbase,(float) (1));
 if (true) break;
...
parent._xuiviewsutils._setalpha /*String*/ (parent._mbase,(float) (0.4));
 if (true) break;
