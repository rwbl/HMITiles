...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.b4xsearchtemplate", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public com.rwblinn.hmitiles.b4xfloattextfield _searchfield = null;
...
com.rwblinn.hmitiles.b4jtextflow _tf = null;
int _i = 0;
String _item = "";
int _x = 0;
int _pnlcolor = 0;
...
_tf = new com.rwblinn.hmitiles.b4jtextflow();
...
_tf._reset /*com.rwblinn.hmitiles.b4jtextflow*/ ();
...
_tf._append /*com.rwblinn.hmitiles.b4jtextflow*/ (_item.substring((int) (0),_x))._setcolor /*com.rwblinn.hmitiles.b4jtextflow*/ (_customlistview1._defaulttextcolor);
 };
...
_tf._append /*com.rwblinn.hmitiles.b4jtextflow*/ (_item.substring(_x,(int) (_x+_full.length())))._setcolor /*com.rwblinn.hmitiles.b4jtextflow*/ (_texthighlightcolor);
 };
...
_tf._append /*com.rwblinn.hmitiles.b4jtextflow*/ (_item.substring((int) (_x+_full.length())))._setcolor /*com.rwblinn.hmitiles.b4jtextflow*/ (_customlistview1._defaulttextcolor);
 };
...
_searchfield = new com.rwblinn.hmitiles.b4xfloattextfield();
...
__c.LogImpl("960555295","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public ResumableSub_Show(com.rwblinn.hmitiles.b4xsearchtemplate parent,com.rwblinn.hmitiles.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
com.rwblinn.hmitiles.b4xsearchtemplate parent;
