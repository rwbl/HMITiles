...
public class b4xtimedtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.b4xtimedtemplate", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.b4xtimedtemplate.class).invoke(this, new Object[] {null});
        else
...
public com.rwblinn.hmitiles.anotherprogressbar _anotherprogressbar1 = null;
...
_anotherprogressbar1 = new com.rwblinn.hmitiles.anotherprogressbar();
...
public ResumableSub_Show(com.rwblinn.hmitiles.b4xtimedtemplate parent,com.rwblinn.hmitiles.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
com.rwblinn.hmitiles.b4xtimedtemplate parent;
