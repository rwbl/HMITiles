...
public class b4xplusminus extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.b4xplusminus", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.b4xplusminus.class).invoke(this, new Object[] {null});
        else
...
public com.rwblinn.hmitiles.b4xformatter _formatter = null;
...
_formatter = new com.rwblinn.hmitiles.b4xformatter();
...
_formatter._getdefaultformat /*com.rwblinn.hmitiles.b4xformatter._b4xformatdata*/ ().FormatFont /*anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont*/  = _mainlabel.getFont();
 //BA.debugLineNum = 63;BA.debugLine="Formatter.GetDefaultFormat.TextColor = MainLabel.";
_formatter._getdefaultformat /*com.rwblinn.hmitiles.b4xformatter._b4xformatdata*/ ().TextColor /*int*/  = _mainlabel.getTextColor();
...
public ResumableSub_StartDownLoop(com.rwblinn.hmitiles.b4xplusminus parent,boolean _up) {
this.parent = parent;
this._up = _up;
}
com.rwblinn.hmitiles.b4xplusminus parent;
boolean _up;
int _myindex = 0;
