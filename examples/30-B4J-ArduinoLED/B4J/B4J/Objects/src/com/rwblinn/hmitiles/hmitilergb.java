...
public class hmitilergb extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.hmitilergb", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.hmitilergb.class).invoke(this, new Object[] {null});
        else
...
public com.rwblinn.hmitiles.b4xseekbar _b4xseekbarred = null;
public com.rwblinn.hmitiles.b4xseekbar _b4xseekbargreen = null;
public com.rwblinn.hmitiles.b4xseekbar _b4xseekbarblue = null;
...
_b4xseekbarred = new com.rwblinn.hmitiles.b4xseekbar();
 //BA.debugLineNum = 53;BA.debugLine="Private B4XSeekBarGreen As B4XSeekBar";
_b4xseekbargreen = new com.rwblinn.hmitiles.b4xseekbar();
 //BA.debugLineNum = 54;BA.debugLine="Private B4XSeekBarBlue As B4XSeekBar";
_b4xseekbarblue = new com.rwblinn.hmitiles.b4xseekbar();
...
public String  _horizontallayoutsliderrow(com.rwblinn.hmitiles.b4xseekbar _bar,anywheresoftware.b4a.objects.B4XViewWrapper _valuelabel,double _top,double _rowheight,double _width) throws Exception{
int _padding = 0;
int _labelw = 0;
int _barw = 0;
...
public String  _verticallayoutslidercolumn(com.rwblinn.hmitiles.b4xseekbar _bar,anywheresoftware.b4a.objects.B4XViewWrapper _valuelabel,double _left,double _columnwidth,double _top,double _columnheight) throws Exception{
int _valuelabelh = 0;
int _slidertop = 0;
int _sliderheight = 0;
