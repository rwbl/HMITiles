...
public class b4xcombobox extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.b4xcombobox", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.b4xcombobox.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_RaiseEvent(com.rwblinn.hmitiles.b4xcombobox parent) {
this.parent = parent;
}
com.rwblinn.hmitiles.b4xcombobox parent;
int _index = 0;
int _myindex = 0;
