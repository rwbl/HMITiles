...
public class b4xfloattextfield extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.b4xfloattextfield", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.b4xfloattextfield.class).invoke(this, new Object[] {null});
        else
...
public com.rwblinn.hmitiles.b4xfloattextfield _mnexttextfield = null;
...
_mnexttextfield = new com.rwblinn.hmitiles.b4xfloattextfield();
...
anywheresoftware.b4j.objects.TextInputControlWrapper.TextAreaWrapper _ta = null;
 ...
 //BA.debugLineNum = 334;BA.debugLine="If Multiline = False Then";
if (_multiline==__c.False) { 
 //BA.debugLineNum = 335;BA.debugLine="Dim tf As TextField";
_tf = new anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper();
 //BA.debugLineNum = 336;BA.debugLine="If Password Then tf.InitializePassword(\"tf\") Els";
if (_password) { 
_tf.InitializePassword(ba,"tf");}
else {
_tf.Initialize(ba,"tf");};
 //BA.debugLineNum = 337;BA.debugLine="If ToolTip <> \"\" Then tf.TooltipText = ToolTip";
if ((_tooltip).equals("") == false) { 
_tf.setTooltipText(_tooltip);};
 //BA.debugLineNum = 338;BA.debugLine="Return tf";
if (true) return (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_tf.getObject()));
 ...
 //BA.debugLineNum = 340;BA.debugLine="Dim ta As TextArea";
_ta = new anywheresoftware.b4j.objects.TextInputControlWrapper.TextAreaWrapper();
 //BA.debugLineNum = 341;BA.debugLine="ta.Initialize(\"tf\")";
_ta.Initialize(ba,"tf");
 //BA.debugLineNum = 342;BA.debugLine="ta.WrapText = True";
_ta.setWrapText(__c.True);
 //BA.debugLineNum = 343;BA.debugLine="If ToolTip <> \"\" Then ta.TooltipText = ToolTip";
if ((_tooltip).equals("") == false) { 
_ta.setTooltipText(_tooltip);};
 //BA.debugLineNum = 344;BA.debugLine="Return ta";
...
_keyboardtype = BA.ObjectToString(_props.GetDefault((Object)("KeyboardType"),(Object)("Text")));
 //BA.debugLineNum = 81;BA.debugLine="ToolTip = lbl.TooltipText";
_tooltip = _lbl.getTooltipText();
 //BA.debugLineNum = 82;BA.debugLine="Dim jo As JavaObject = HintImageView";
...
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_hintimageview.getObject()));
 //BA.debugLineNum = 83;BA.debugLine="jo.RunMethod(\"setMouseTransparent\", Array(True))";
...
__c.LogImpl("951249176","Multiline not supported with password mode.",0);
 };
...
public com.rwblinn.hmitiles.b4xfloattextfield  _getnextfield() throws Exception{
...
if (_mnexttextfield.IsInitialized /*boolean*/ ()==__c.False || (_mnexttextfield).equals((com.rwblinn.hmitiles.b4xfloattextfield)(this))) { 
 //BA.debugLineNum = 432;BA.debugLine="mTextField.Parent.RequestFocus";
...
public String  _lc_mouseclicked(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 449;BA.debugLine="Private Sub lc_MouseClicked(EventData As MouseEven";
 //BA.debugLineNum = 450;BA.debugLine="EventData.Consume";
_eventdata.Consume();
 //BA.debugLineNum = 451;BA.debugLine="lc_Click";
_lc_click();
...
public String  _lc_mousepressed(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 445;BA.debugLine="Private Sub lc_MousePressed (EventData As MouseEve";
 //BA.debugLineNum = 446;BA.debugLine="EventData.Consume";
_eventdata.Consume();
...
public String  _lc_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 454;BA.debugLine="Private Sub lc_MouseReleased(EventData As MouseEve";
 //BA.debugLineNum = 455;BA.debugLine="EventData.Consume";
_eventdata.Consume();
...
public String  _setnextfield(com.rwblinn.hmitiles.b4xfloattextfield _field) throws Exception{
Object _o = null;
...
_mnexttextfield = (com.rwblinn.hmitiles.b4xfloattextfield)(_o);
...
anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper _tf = null;
 //BA.debugLineNum = 140;BA.debugLine="Private Sub SwitchFromPasswordToRegular (ToRegular";
...
_base_resize(_mbase.getWidth(),_mbase.getHeight());
 //BA.debugLineNum = 162;BA.debugLine="Dim tf As TextField = mTextField";
_tf = new anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper();
_tf = (anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper(), (javafx.scene.control.TextField)(_mtextfield.getObject()));
 //BA.debugLineNum = 163;BA.debugLine="tf.SetSelection(mTextField.Text.Length, mTextFiel";
...
if (_mnexttextfield.IsInitialized /*boolean*/ () && (_mnexttextfield).equals((com.rwblinn.hmitiles.b4xfloattextfield)(this)) == false) { 
