...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.b4xformatter", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.b4xformatter.class).invoke(this, new Object[] {null});
        else
...
public String  _addformatdata(com.rwblinn.hmitiles.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
double _factor = 0;
...
public com.rwblinn.hmitiles.b4xformatter._b4xformatdata  _copyformatdata(com.rwblinn.hmitiles.b4xformatter._b4xformatdata _data) throws Exception{
com.rwblinn.hmitiles.b4xformatter._b4xformatdata _d = null;
...
_d = new com.rwblinn.hmitiles.b4xformatter._b4xformatdata();
...
public com.rwblinn.hmitiles.b4xformatter._b4xformatdata  _createdefaultformat() throws Exception{
com.rwblinn.hmitiles.b4xformatter._b4xformatdata _d = null;
...
com.rwblinn.hmitiles.b4xformatter._b4xformatdata _data = null;
...
public com.rwblinn.hmitiles.b4xformatter._b4xformatdata  _getdefaultformat() throws Exception{
...
if (true) return (com.rwblinn.hmitiles.b4xformatter._b4xformatdata)(_formats.Get((int) (0)));
 //BA.debugLineNum = 80;BA.debugLine="End Sub";
return null;
}
public com.rwblinn.hmitiles.b4xformatter._b4xformatdata  _getformatdata(double _number) throws Exception{
int _i = 0;
com.rwblinn.hmitiles.b4xformatter._b4xformatdata _d = null;
...
_d = (com.rwblinn.hmitiles.b4xformatter._b4xformatdata)(_formats.Get(_i));
...
public com.rwblinn.hmitiles.b4xformatter._b4xformatdata  _newformatdata() throws Exception{
