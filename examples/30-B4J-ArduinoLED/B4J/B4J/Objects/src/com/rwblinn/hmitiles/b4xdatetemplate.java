...
public class b4xdatetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.b4xdatetemplate", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.b4xdatetemplate.class).invoke(this, new Object[] {null});
        else
...
public com.rwblinn.hmitiles.b4xdialog _mdialog = null;
...
_mdialog = new com.rwblinn.hmitiles.b4xdialog();
...
_lblmonth.setText(BA.ObjectToString(_monthsnames.Get((int) (_month-1))));
...
_monthsnames = _dateutils._getmonthsnames();
...
_cvsdays.Initialize(ba,_daystitlespane);
 //BA.debugLineNum = 54;BA.debugLine="Dim p As Pane = DaysPaneFg";
...
_p = (anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper(), (javafx.scene.layout.Pane)(_dayspanefg.getObject()));
 //BA.debugLineNum = 55;BA.debugLine="Private fx As JFX";
_fx = new anywheresoftware.b4j.objects.JFX();
 //BA.debugLineNum = 56;BA.debugLine="p.MouseCursor = fx.Cursors.HAND";
...
_daysofweeknames.AddAll(_dateutils._getdaysnames());
...
public ResumableSub_Show(com.rwblinn.hmitiles.b4xdatetemplate parent,com.rwblinn.hmitiles.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
com.rwblinn.hmitiles.b4xdatetemplate parent;
...
parent._cvsdays.DrawText(_d,(_i-parent._firstday+0.5)*parent._boxw,parent.__c.DipToCurrent((int) (20)),_daysfont,parent._daysinweekcolor,BA.getEnumFromString(javafx.scene.text.TextAlignment.class,"CENTER"));
 if (true) break;
if (true) break;
