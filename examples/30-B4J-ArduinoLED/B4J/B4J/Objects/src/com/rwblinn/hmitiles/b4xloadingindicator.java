...
public class b4xloadingindicator extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.b4xloadingindicator", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.b4xloadingindicator.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_MainLoop(com.rwblinn.hmitiles.b4xloadingindicator parent) {
this.parent = parent;
}
com.rwblinn.hmitiles.b4xloadingindicator parent;
int _myindex = 0;
long _n = 0L;
float _progress = 0f;
