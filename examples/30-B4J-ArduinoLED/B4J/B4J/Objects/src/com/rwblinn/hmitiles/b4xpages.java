...
public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.b4xpages", null);
		ba.loadHtSubs(b4xpages.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "com.rwblinn.hmitiles.b4xpages", ba);
		}
	}
...
public static com.rwblinn.hmitiles.b4xpagesdelegator _delegate = null;
public static Object _globalcontext = null;
public static b4j.example.dateutils _dateutils = null;
public static b4j.example.cssutils _cssutils = null;
public static com.rwblinn.hmitiles.main _main = null;
public static com.rwblinn.hmitiles.b4xcollections _b4xcollections = null;
public static com.rwblinn.hmitiles.hmitileutils _hmitileutils = null;
public static com.rwblinn.hmitiles.xuiviewsutils _xuiviewsutils = null;
...
public static com.rwblinn.hmitiles.b4xpagesmanager  _getmanager() throws Exception{
 //BA.debugLineNum = 14;BA.debugLine="Public Sub GetManager As B4XPagesManager";
 //BA.debugLineNum = 15;BA.debugLine="Return mPM";
if (true) return (com.rwblinn.hmitiles.b4xpagesmanager)(_mpm);
...
if (true) return _getmanager()._findpifromb4xpage /*com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo*/ (_b4xpage).Parent /*com.rwblinn.hmitiles.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4j.objects.Form*/ ;
...
if (true) return _getmanager()._findpifromb4xpage /*com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo*/ (_b4xpage).Id /*String*/ ;
...
if (true) return _mpm instanceof com.rwblinn.hmitiles.b4xpagesmanager;
 //BA.debugLineNum = 11;BA.debugLine="End Sub";
return false;
}
public static com.rwblinn.hmitiles.b4xmainpage  _mainpage() throws Exception{
...
if (true) return _getmanager()._mainpage /*com.rwblinn.hmitiles.b4xmainpage*/ ;
...
_delegate = new com.rwblinn.hmitiles.b4xpagesdelegator();
