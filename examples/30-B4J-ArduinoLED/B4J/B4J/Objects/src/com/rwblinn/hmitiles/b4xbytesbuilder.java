...
public class b4xbytesbuilder extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.b4xbytesbuilder", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.b4xbytesbuilder.class).invoke(this, new Object[] {null});
        else
...
public com.rwblinn.hmitiles.b4xbytesbuilder  _append(byte[] _data) throws Exception{
...
public com.rwblinn.hmitiles.b4xbytesbuilder  _append2(byte[] _data,int _startindex,int _length) throws Exception{
int _oldlength = 0;
...
if (true) return (com.rwblinn.hmitiles.b4xbytesbuilder)(this);
