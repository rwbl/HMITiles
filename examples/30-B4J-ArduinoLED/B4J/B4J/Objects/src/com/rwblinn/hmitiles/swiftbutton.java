...
public class swiftbutton extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.swiftbutton", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.swiftbutton.class).invoke(this, new Object[] {null});
        else
...
public String  _p_mouseclicked(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 106;BA.debugLine="Private Sub p_MouseClicked (EventData As MouseEven";
 //BA.debugLineNum = 107;BA.debugLine="EventData.Consume";
_eventdata.Consume();
