...
public class b4xpagesdelegator extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.b4xpagesdelegator", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.b4xpagesdelegator.class).invoke(this, new Object[] {null});
        else
...
_b4xpages._getmanager /*com.rwblinn.hmitiles.b4xpagesmanager*/ ()._activity_pause /*String*/ ();
...
_b4xpages._getmanager /*com.rwblinn.hmitiles.b4xpagesmanager*/ ()._activity_resume /*String*/ ();
...
_b4xpages._getmanager /*com.rwblinn.hmitiles.b4xpagesmanager*/ ()._mainform_closed /*String*/ ();
...
_b4xpages._getmanager /*com.rwblinn.hmitiles.b4xpagesmanager*/ ()._mainform_closerequest /*String*/ (_eventdata);
...
_b4xpages._getmanager /*com.rwblinn.hmitiles.b4xpagesmanager*/ ()._mainform_focuschanged /*String*/ (_hasfocus);
...
_b4xpages._getmanager /*com.rwblinn.hmitiles.b4xpagesmanager*/ ()._mainform_iconifiedchanged /*String*/ (_iconified);
...
_b4xpages._getmanager /*com.rwblinn.hmitiles.b4xpagesmanager*/ ()._mainform_resize /*String*/ (_width,_height);
