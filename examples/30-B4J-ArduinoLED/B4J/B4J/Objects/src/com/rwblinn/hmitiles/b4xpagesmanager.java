...
public class b4xpagesmanager extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.b4xpagesmanager", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.b4xpagesmanager.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public com.rwblinn.hmitiles.b4xorderedmap _idtob4xpage = null;
public com.rwblinn.hmitiles.b4xorderedmap _rootb4xtopage = null;
public com.rwblinn.hmitiles.b4xset _mstackofpageids = null;
public anywheresoftware.b4a.objects.B4XViewWrapper.XUI _xui = null;
public anywheresoftware.b4j.objects.Form _mmainform = null;
public boolean _isforeground = false;
public int _transitionanimationduration = 0;
public com.rwblinn.hmitiles.b4xmainpage _mainpage = null;
...
public com.rwblinn.hmitiles.b4xpagesmanager._b4xpageparent Parent;
public void Initialize() {
IsInitialized = true;
B4XPage = new Object();
Id = "";
...
IsFirst = false;
Parent = new com.rwblinn.hmitiles.b4xpagesmanager._b4xpageparent();
}
@Override
		public String toString() {
			return BA.TypeToString(this, false);
...
__c.LogImpl("99895939",("Page with this id already exists: "+__c.SmartStringFormatter("",(Object)(_idtolower))+"!"),0);
...
String _ev = "";
com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo _pi = null;
...
_pi = (com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo)(group5.Get(index5));
...
_idtob4xpage = new com.rwblinn.hmitiles.b4xorderedmap();
 //BA.debugLineNum = 24;BA.debugLine="Private RootB4XToPage As B4XOrderedMap";
_rootb4xtopage = new com.rwblinn.hmitiles.b4xorderedmap();
...
_mstackofpageids = new com.rwblinn.hmitiles.b4xset();
...
_mainpage = new com.rwblinn.hmitiles.b4xmainpage();
...
__c.LogImpl("910158084","Only top page can be closed",0);
...
__c.LogImpl("910158087","First page cannot be closed",0);
...
public String  _closepageimpl(com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
_pi.Parent /*com.rwblinn.hmitiles.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4j.objects.Form*/ .Close();
 //BA.debugLineNum = 331;BA.debugLine="End Sub";
return "";
}
public boolean  _closerequestexists(com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
public com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo  _createb4xpageinfo(Object _b4xpage,String _id,boolean _created,Object _title) throws Exception{
com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo _t1 = null;
...
_t1 = new com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo();
...
public com.rwblinn.hmitiles.b4xpagesmanager._b4xpageparent  _createb4xpageparent(anywheresoftware.b4j.objects.Form _nativetype) throws Exception{
com.rwblinn.hmitiles.b4xpagesmanager._b4xpageparent _t1 = null;
...
_t1 = new com.rwblinn.hmitiles.b4xpagesmanager._b4xpageparent();
...
public String  _createpageifneeded(com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
public String  _createpageimpl(com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
_pi.Parent /*com.rwblinn.hmitiles.b4xpagesmanager._b4xpageparent*/  = _createb4xpageparent(_mmainform);
 }else {
...
_pi.Parent /*com.rwblinn.hmitiles.b4xpagesmanager._b4xpageparent*/  = _createb4xpageparent(_f);
 };
 //BA.debugLineNum = 378;BA.debugLine="pi.Root = pi.Parent.NativeType.RootPane";
_pi.Root /*anywheresoftware.b4a.objects.B4XViewWrapper*/  = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_pi.Parent /*com.rwblinn.hmitiles.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4j.objects.Form*/ .getRootPane().getObject()));
 //BA.debugLineNum = 379;BA.debugLine="pi.Parent.NativeType.Title = pi.Title";
_pi.Parent /*com.rwblinn.hmitiles.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4j.objects.Form*/ .setTitle(BA.ObjectToString(_pi.Title /*Object*/ ));
 //BA.debugLineNum = 392;BA.debugLine="End Sub";
return "";
}
public com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo  _findpifromb4xpage(Object _page) throws Exception{
com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo _pi = null;
...
_pi = (com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo)(group1.Get(index1));
...
if (true) return (com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo)(__c.Null);
...
public com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo  _getpagefromid(String _id) throws Exception{
com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo _pi = null;
...
_pi = (com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo)(_idtob4xpage._get /*Object*/ ((Object)(_id.toLowerCase())));
 //BA.debugLineNum = 400;BA.debugLine="If pi = Null Then";
if (_pi== null) { 
 //BA.debugLineNum = 401;BA.debugLine="Log(\"Error: page id not found: \" & id)";
__c.LogImpl("910813443","Error: page id not found: "+_id,0);
 //BA.debugLineNum = 402;BA.debugLine="Log(\"Ids: \" & IdToB4XPage.Keys) 'ignore";
__c.LogImpl("910813444","Ids: "+BA.ObjectToString(_idtob4xpage._getkeys /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
public com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo  _getpageinfofromroot(anywheresoftware.b4a.objects.B4XViewWrapper _root) throws Exception{
...
if (true) return (com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo)(_rootb4xtopage._get /*Object*/ ((Object)(_root.getObject())));
 //BA.debugLineNum = 409;BA.debugLine="End Sub";
return null;
}
public com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo  _gettoppage() throws Exception{
...
if (true) return (com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo)(_idtob4xpage._get /*Object*/ (_mstackofpageids._aslist /*anywheresoftware.b4a.objects.collections.List*/ ().Get((int) (_mstackofpageids._getsize /*int*/ ()-1))));
 //BA.debugLineNum = 595;BA.debugLine="End Sub";
return null;
}
public void  _handlecloserequest(com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
ResumableSub_HandleCloseRequest rsub = new ResumableSub_HandleCloseRequest(this,_pi);
rsub.resume(ba, null);
}
public static class ResumableSub_HandleCloseRequest extends BA.ResumableSub {
public ResumableSub_HandleCloseRequest(com.rwblinn.hmitiles.b4xpagesmanager parent,com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo _pi) {
this.parent = parent;
this._pi = _pi;
}
com.rwblinn.hmitiles.b4xpagesmanager parent;
com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo _pi;
...
__c.LogImpl("99830429","Call B4XPages.GetManager.LogEvents = True to enable logging B4XPages events.",0);
 };
...
public String  _logevent(com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo _pi,String _ev) throws Exception{
String _msg = "";
...
public String  _movepagetotop(com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
public String  _raiseevent(com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo _targetpage,String _subname,Object[] _params) throws Exception{
int _length = 0;
...
public Object  _raiseeventwithresult(com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo _targetpage,String _subname,Object[] _params) throws Exception{
int _length = 0;
...
_pi.Parent /*com.rwblinn.hmitiles.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4j.objects.Form*/ .setTitle(BA.ObjectToString(_title));
...
com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo _pi = null;
com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo _pagetoremove = null;
...
_pagetoremove.Parent /*com.rwblinn.hmitiles.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4j.objects.Form*/ .Close();
 }
};
...
public String  _showpageimpl(com.rwblinn.hmitiles.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
_pi.Parent /*com.rwblinn.hmitiles.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4j.objects.Form*/ .Show();
 //BA.debugLineNum = 336;BA.debugLine="Dim jo As JavaObject = pi.Parent.NativeType";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_pi.Parent /*com.rwblinn.hmitiles.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4j.objects.Form*/ ));
