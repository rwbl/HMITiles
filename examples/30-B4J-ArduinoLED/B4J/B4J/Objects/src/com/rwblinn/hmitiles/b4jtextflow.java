...
public class b4jtextflow extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.b4jtextflow", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.b4jtextflow.class).invoke(this, new Object[] {null});
        else
...
public com.rwblinn.hmitiles.b4jtextflow  _append(String _text) throws Exception{
...
if (true) return (com.rwblinn.hmitiles.b4jtextflow)(this);
...
public com.rwblinn.hmitiles.b4jtextflow  _reset() throws Exception{
...
public com.rwblinn.hmitiles.b4jtextflow  _setcolor(int _color) throws Exception{
...
public com.rwblinn.hmitiles.b4jtextflow  _setfont(anywheresoftware.b4j.objects.JFX.FontWrapper _font) throws Exception{
...
public com.rwblinn.hmitiles.b4jtextflow  _setstrikethrough(boolean _strikethrough) throws Exception{
...
public com.rwblinn.hmitiles.b4jtextflow  _setunderline(boolean _underline) throws Exception{
