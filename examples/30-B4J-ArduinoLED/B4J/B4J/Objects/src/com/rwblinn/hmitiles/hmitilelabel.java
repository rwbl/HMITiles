...
public class hmitilelabel extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.hmitilelabel", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.hmitilelabel.class).invoke(this, new Object[] {null});
        else
...
String _state = "";
 //BA.debugLineNum = 146;BA.debugLine="Public Sub ApplyStyle(tilestate As String)";
 //BA.debugLineNum = 148;BA.debugLine="Dim state As String = HMITileUtils.StateStyleToSt";
_state = BA.NumberToString(_hmitileutils._statestyletostate /*int*/ (_tilestate));
 //BA.debugLineNum = 151;BA.debugLine="LabelText.TextSize = HMITileUtils.TEXT_SIZE_TITLE";
_labeltext.setTextSize(_hmitileutils._text_size_title /*float*/ );
 //BA.debugLineNum = 152;BA.debugLine="LabelText.TextColor = HMITileUtils.COLOR_TEXT_PRI";
_labeltext.setTextColor(_hmitileutils._color_text_primary /*int*/ );
 //BA.debugLineNum = 154;BA.debugLine="Select state";
...
case 0: {
 //BA.debugLineNum = 156;BA.debugLine="mBase.Color = HMITileUtils.COLOR_TILE_NORMAL_BA";
_mbase.setColor(_hmitileutils._color_tile_normal_background /*int*/ );
 //BA.debugLineNum = 157;BA.debugLine="LabelText.TextColor = HMITileUtils.COLOR_TEXT_P";
_labeltext.setTextColor(_hmitileutils._color_text_primary /*int*/ );
 break; }
case 1: {
 //BA.debugLineNum = 160;BA.debugLine="mBase.Color = HMITileUtils.COLOR_TILE_WARNING_B";
_mbase.setColor(_hmitileutils._color_tile_warning_background /*int*/ );
 //BA.debugLineNum = 161;BA.debugLine="LabelText.TextColor = HMITileUtils.COLOR_TEXT_W";
_labeltext.setTextColor(_hmitileutils._color_text_warning /*int*/ );
 break; }
case 2: {
 //BA.debugLineNum = 164;BA.debugLine="mBase.Color = HMITileUtils.COLOR_TILE_ALARM_BAC";
_mbase.setColor(_hmitileutils._color_tile_alarm_background /*int*/ );
 //BA.debugLineNum = 165;BA.debugLine="LabelText.TextColor = HMITileUtils.COLOR_TEXT_E";
_labeltext.setTextColor(_hmitileutils._color_text_error /*int*/ );
 break; }
case 3: {
 //BA.debugLineNum = 168;BA.debugLine="mBase.Color = HMITileUtils.COLOR_TILE_DISABLED_";
_mbase.setColor(_hmitileutils._color_tile_disabled_background /*int*/ );
 //BA.debugLineNum = 169;BA.debugLine="LabelText.TextColor = HMITileUtils.COLOR_TEXT_D";
...
public String  _gettypestyle() throws Exception{
 //BA.debugLineNum = 134;BA.debugLine="Public Sub getTypeStyle As String";
 //BA.debugLineNum = 135;BA.debugLine="Return mTypeStyle";
...
public String  _labeltext_click() throws Exception{
 ...
 //BA.debugLineNum = 189;BA.debugLine="If SubExists(mCallBack, mEventName & \"_Click\") Th";
if (__c.SubExists(ba,_mcallback,_meventname+"_Click")) { 
 //BA.debugLineNum = 190;BA.debugLine="CallSub(mCallBack, mEventName & \"_Click\")";
...
public String  _labeltext_mouseclicked(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 182;BA.debugLine="Private Sub LabelText_MouseClicked (EventData As M";
 //BA.debugLineNum = 183;BA.debugLine="LabelText_Click";
_labeltext_click();
 //BA.debugLineNum = 184;BA.debugLine="End Sub";
return "";
}
public String  _setalarm(String _text) throws Exception{
 //BA.debugLineNum = 125;BA.debugLine="Public Sub SetAlarm(text As String)";
 //BA.debugLineNum = 126;BA.debugLine="setText(text)";
_settext(_text);
 //BA.debugLineNum = 127;BA.debugLine="setTypeStyle(HMITileUtils.TYPESTYLE_ALARM)";
...
public String  _setinfo(String _text) throws Exception{
 //BA.debugLineNum = 115;BA.debugLine="Public Sub SetInfo(text As String)";
 //BA.debugLineNum = 116;BA.debugLine="setText(text)";
_settext(_text);
 //BA.debugLineNum = 117;BA.debugLine="setTypeStyle(HMITileUtils.TYPESTYLE_NORMAL)";
...
public String  _settypestyle(String _value) throws Exception{
 //BA.debugLineNum = 130;BA.debugLine="Public Sub setTypeStyle(value As String)";
 //BA.debugLineNum = 131;BA.debugLine="mTypeStyle = value";
_mtypestyle = _value;
 //BA.debugLineNum = 132;BA.debugLine="ApplyStyle(mTypeStyle)";
_applystyle(_mtypestyle);
 //BA.debugLineNum = 133;BA.debugLine="End Sub";
return "";
}
public String  _setwarning(String _text) throws Exception{
 //BA.debugLineNum = 120;BA.debugLine="Public Sub SetWarning(text As String)";
 //BA.debugLineNum = 121;BA.debugLine="setText(text)";
_settext(_text);
 //BA.debugLineNum = 122;BA.debugLine="setTypeStyle(HMITileUtils.TYPESTYLE_WARNING)";
