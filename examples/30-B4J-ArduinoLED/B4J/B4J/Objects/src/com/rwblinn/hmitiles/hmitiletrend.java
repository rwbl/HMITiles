...
public class hmitiletrend extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("com.rwblinn.hmitiles", "com.rwblinn.hmitiles.hmitiletrend", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.rwblinn.hmitiles.hmitiletrend.class).invoke(this, new Object[] {null});
        else
...
__c.LogImpl("941287682","[HMITileTrend.DrawChart] Chart not ready yet.",0);
...
__c.LogImpl("941287688","[HMITileTrend.DrawChart] Chart not ready yet.",0);
...
__c.LogImpl("941287694",("[HMITileTrend.DrawChart] No chart data."),0);
...
__c.LogImpl("941353219",("[HMITileTrend.UpdateChart] No chart data."),0);
