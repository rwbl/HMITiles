...
Private Sub TileCustomLabel
	...
	Dim idx As Int = 0
	' Label
	For Each v As B4XView In TileLabel.mBase.GetAllViewsRecursive
	...
	' Get b4xview
	Dim vw0 As B4XView = TileLabel.mBase.GetView(0)
	' Change properties
	Try
		vw0.TextSize = 48
...
Private Sub TileCustomLabelIcon
	...
	Dim idx As Int = 0
	' Label
	For Each v As B4XView In TileLabelIcon.mBase.GetAllViewsRecursive
	...
	' Get b4xview
	Dim vw0 As B4XView = TileLabelIcon.mBase.GetView(0)
	' Change properties
	Try
		...
		Log($"[TileCustomLabelIcon] size=${vw0.Font.size} / ${TileLabelIcon.mBase.Width}"$)
	Catch
...
Private Sub TileCustomReadOut
	...
	Dim idx As Int = 0
	' Label
	For Each v As B4XView In TileReadout.mBase.GetAllViewsRecursive
	...
	' Get b4xviews
	Dim vw0 As B4XView = TileReadout.mBase.GetView(0)
	Dim vw1 As B4XView = TileReadout.mBase.GetView(1)
	Dim vw2 As B4XView = TileReadout.mBase.GetView(2)
	' Change properties
	Try
