...
__c.LogImpl("924051736","Multiline not supported with password mode.",0);
 };
...
public b4j.example.b4xfloattextfield  _getnextfield() throws Exception{
...
if (_mnexttextfield.IsInitialized /*boolean*/ ()==__c.False || (_mnexttextfield).equals((b4j.example.b4xfloattextfield)(this))) { 
...
public String  _setnextfield(b4j.example.b4xfloattextfield _field) throws Exception{
Object _o = null;
...
_mnexttextfield = (b4j.example.b4xfloattextfield)(_o);
...
if (_mnexttextfield.IsInitialized /*boolean*/ () && (_mnexttextfield).equals((b4j.example.b4xfloattextfield)(this)) == false) { 
