...
__c.LogImpl("948234520",("[HMITileImage.LoadImage][E] Unable to load image '"+__c.SmartStringFormatter("",(Object)(_mimagename))+"': "+__c.SmartStringFormatter("",(Object)(__c.LastException(ba).getObject()))+""),0);
 };
 }else {
 //BA.debugLineNum = 95;BA.debugLine="Log($\"[HMITileImage][E] Image not found ${folde";
__c.LogImpl("948234523",("[HMITileImage][E] Image not found "+__c.SmartStringFormatter("",(Object)(_folder))+" "+__c.SmartStringFormatter("",(Object)(_mimagename))+""),0);
 };
 };
...
__c.LogImpl("948431119",("[HMITileImage.SetImage][E] Unable to load image '"+__c.SmartStringFormatter("",(Object)(_image))+"': "+__c.SmartStringFormatter("",(Object)(__c.LastException(ba).getObject()))+""),0);
 };
