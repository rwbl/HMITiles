...
public class b4xtimedtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.b4xtimedtemplate", this);
            if (htSubs == null) {
...
public ResumableSub_Show(b4j.example.b4xtimedtemplate parent,b4j.example.b4xdialog _dialog) {
this.parent = parent;
