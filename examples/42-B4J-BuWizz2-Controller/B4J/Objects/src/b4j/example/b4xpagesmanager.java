...
__c.LogImpl("913107203",("Page with this id already exists: "+__c.SmartStringFormatter("",(Object)(_idtolower))+"!"),0);
...
__c.LogImpl("913369348","Only top page can be closed",0);
...
__c.LogImpl("913369351","First page cannot be closed",0);
...
__c.LogImpl("914024707","Error: page id not found: "+_id,0);
 //BA.debugLineNum = 402;BA.debugLine="Log(\"Ids: \" & IdToB4XPage.Keys) 'ignore";
__c.LogImpl("914024708","Ids: "+BA.ObjectToString(_idtob4xpage._getkeys /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
__c.LogImpl("913041693","Call B4XPages.GetManager.LogEvents = True to enable logging B4XPages events.",0);
 };
...
__c.LogImpl("914680078","Too many parameters",0);
 break; }
}
;
...
__c.LogImpl("914745614","Too many parameters",0);
 break; }
}
;
