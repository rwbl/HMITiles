...
Private Sub TileSPPVsSetProperties
	...
	TileSPPV2.DeviationWarning = 3
	TileSPPV2.DeviationAlarm = 4
	TileSPPV2.PV = 6
	TileSPPV2.SP = 3
	TileSPPV2.Max = 10
	TileSPPV2.Min = 0
...
Private Sub TileSPPV1_ValueChanged (Value As Float)
	Log($"[TileSPPV1_ValueChanged] value=${Value} deviation=${TileSPPV1.Deviation} deviationwarning/alarm=${TileSPPV1.deviationwarning}/${TileSPPV1.deviationalarm}"$)
End Sub
...
Private Sub TileSPPV2_ValueChanged (Value As Float)
	Log($"[TileSPPV2_ValueChanged] value=${Value} deviation=${TileSPPV2.Deviation} deviationwarning/alarm=${TileSPPV2.deviationwarning}/${TileSPPV2.deviationalarm}"$)
End Sub
