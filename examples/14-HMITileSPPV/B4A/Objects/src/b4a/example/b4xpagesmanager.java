...
__c.LogImpl("910354691",("Page with this id already exists: "+__c.SmartStringFormatter("",(Object)(_idtolower))+"!"),0);
...
__c.LogImpl("910223637","#SupportedOrientations attribute must be set to landscape or portrait.",_xui.Color_Red);
 };
 };
 }
};
...
__c.LogImpl("910616836","Only top page can be closed",0);
...
__c.LogImpl("910616839","First page cannot be closed",0);
...
__c.LogImpl("911272195","Error: page id not found: "+_id,0);
 //BA.debugLineNum = 402;BA.debugLine="Log(\"Ids: \" & IdToB4XPage.Keys) 'ignore";
__c.LogImpl("911272196","Ids: "+BA.ObjectToString(_idtob4xpage._getkeys /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
__c.LogImpl("910158107","Call B4XPages.GetManager.LogEvents = True to enable logging B4XPages events.",0);
 };
...
__c.LogImpl("911862030","Too many parameters",0);
 break; }
}
;
...
__c.LogImpl("911927566","Too many parameters",0);
 break; }
}
;
