...
public class hmitilelist extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example.hmitilelist");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.example.hmitilelist.class).invoke(this, new Object[] {null});
        else
...
public String  _afterloadlayout(anywheresoftware.b4a.objects.collections.Map _props) throws Exception{
 ...
 //BA.debugLineNum = 80;BA.debugLine="mBase.LoadLayout(\"hmitilelist\")";
...
_applystyle();
 //BA.debugLineNum = 93;BA.debugLine="Base_Resize(mBase.Width, mBase.Height)";
...
_hmitileutils._setclvbackgroundtransparent /*String*/ (ba,_clvlist);
...
_clvlist._sv.SetColorAndBorder(_hmitileutils._color_background_default /*int*/ ,__c.DipToCurrent((int) (1)),_hmitileutils._color_status_off_border /*int*/ ,__c.DipToCurrent((int) (0)));
 //BA.debugLineNum = 183;BA.debugLine="mBase.Color = HMITileUtils.COLOR_TILE_NORMAL_BACK";
_mbase.setColor(_hmitileutils._color_tile_normal_background /*int*/ );
 //BA.debugLineNum = 185;BA.debugLine="mBase.SetColorAndBorder(mBase.Color, 0, 0, HMITil";
...
_w = 0f;
_h = 0f;
 //BA.debugLineNum = 98;BA.debugLine="Dim pad As Int = HMITileUtils.BORDER_WIDTH + 4dip";
...
_panelist.SetLayoutAnimated((int) (0),(int) (0),(int) (0),(int) (_width),(int) (_height));
...
_labeltitle.SetLayoutAnimated((int) (0),(int) (0),(int) (0),_panelist.getWidth(),_hmitileutils._event_title_height /*int*/ );
 };
...
_clvlist._getbase().SetLayoutAnimated((int) (0),(int) (_l),(int) (_t),(int) (_w),(int) (_h));
...
_mbase = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 43;BA.debugLine="Public mLbl As B4XView";
...
_clvlist = new b4a.example3.customlistview();
...
public anywheresoftware.b4a.objects.PanelWrapper  _clvlistcreateitem(String _primaryitem,String _secondaryitem) throws Exception{
int _rowheight = 0;
int _rowpadding = 0;
...
anywheresoftware.b4a.objects.B4XViewWrapper _lblsecondaryitem = null;
 //BA.debugLineNum = 265;BA.debugLine="Private Sub ClvListCreateItem(primaryitem As Strin";
...
_pnl.SetLayoutAnimated((int) (0),_rowpadding,_rowpadding,(int) (_clvlist._asview().getWidth()-(_rowpadding*2)),_rowheight);
...
_lblsecondaryitem = _xuiviewsutils._createlabel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ (ba);
...
_lblsecondaryitem.setText(BA.ObjectToCharSequence(_secondaryitem));
...
_hmitileutils._settextcolorcrossplatform /*String*/ (ba,_lblsecondaryitem,("#"+__c.SmartStringFormatter("",(Object)(_hmitileutils._colortohexrgb /*String*/ (ba,_hmitileutils._list_color_text /*int*/ )))+""));
 //BA.debugLineNum = 302;BA.debugLine="pnl.AddView(lblsecondaryitem, rowpadding, rowhei";
_pnl.AddView((android.view.View)(_lblsecondaryitem.getObject()),_rowpadding,(int) (_rowheight/(double)2),_pnl.getWidth(),(int) (_pnl.getHeight()/(double)2));
 };
...
_mbase = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_base));
 //BA.debugLineNum = 71;BA.debugLine="mLbl = Lbl";
_mlbl = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_lbl.getObject()));
 //BA.debugLineNum = 72;BA.debugLine="Tag = mBase.Tag";
_tag = _mbase.getTag();
 //BA.debugLineNum = 73;BA.debugLine="mBase.Tag = Me";
_mbase.setTag(this);
...
public boolean  _getenabled() throws Exception{
 ...
 //BA.debugLineNum = 158;BA.debugLine="Return mBase.Enabled";
...
_mbase.setEnabled(_enabled);
 //BA.debugLineNum = 155;BA.debugLine="HMITileUtils.SetAlpha(mBase.enabled)";
