...
public class hmitilergb extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example.hmitilergb");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.example.hmitilergb.class).invoke(this, new Object[] {null});
        else
...
public b4a.example.b4xseekbar _b4xseekbarred = null;
public b4a.example.b4xseekbar _b4xseekbargreen = null;
public b4a.example.b4xseekbar _b4xseekbarblue = null;
...
_labeltitle.SetLayoutAnimated((int) (0),_mpad,_mpad,(int) (_width-_mpad*2),(int) (_height*0.25));
...
_panepreview.SetLayoutAnimated((int) (0),(int) (_mpad*2),(int) (_y),(int) (_width-_mpad*4),(int) (_mpreviewheight));
...
public String  _horizontallayoutsliderrow(b4a.example.b4xseekbar _bar,anywheresoftware.b4a.objects.B4XViewWrapper _valuelabel,double _top,double _rowheight,double _width) throws Exception{
int _padding = 0;
int _labelw = 0;
int _barw = 0;
...
_bar._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetLayoutAnimated((int) (0),_padding,(int) (_top+_padding),_barw,(int) (_rowheight-_padding*2));
...
_valuelabel.SetLayoutAnimated((int) (0),(int) (_barw+_padding),(int) (_top),_labelw,(int) (_rowheight));
...
_labelvaluered.setText(BA.ObjectToCharSequence(_mr));
 //BA.debugLineNum = 211;BA.debugLine="LabelValueGreen.Text = mG";
_labelvaluegreen.setText(BA.ObjectToCharSequence(_mg));
 //BA.debugLineNum = 212;BA.debugLine="LabelValueBlue.Text = mB";
_labelvalueblue.setText(BA.ObjectToCharSequence(_mb));
...
public String  _verticallayoutslidercolumn(b4a.example.b4xseekbar _bar,anywheresoftware.b4a.objects.B4XViewWrapper _valuelabel,double _left,double _columnwidth,double _top,double _columnheight) throws Exception{
int _valuelabelh = 0;
int _slidertop = 0;
int _sliderheight = 0;
...
_valuelabelh = _valuelabel.getHeight();
...
_valuelabel.SetLayoutAnimated((int) (0),(int) (_left+_mpad),(int) (_top+_mpad),(int) (_columnwidth-_mpad*2),_valuelabelh);
...
_bar._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetLayoutAnimated((int) (0),(int) (_left+_mpad),_slidertop,(int) (_columnwidth-_mpad*2),_sliderheight);
