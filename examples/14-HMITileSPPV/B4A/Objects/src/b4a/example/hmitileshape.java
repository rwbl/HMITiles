...
public class hmitileshape extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example.hmitileshape");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.example.hmitileshape.class).invoke(this, new Object[] {null});
        else
...
_canvasshape.Initialize(_paneshape);
...
_paneshape.SetLayoutAnimated((int) (0),(int) (0),(int) (0),(int) (_width),(int) (_height));
...
anywheresoftware.b4a.objects.B4XCanvas.B4XPath _maskarc = null;
 //BA.debugLineNum = 161;BA.debugLine="Private Sub DrawCorner(cx As Float, cy As Float, s";
 //BA.debugLineNum = 162;BA.debugLine="Dim r As Float = PaneShape.Width / 2 + mStrokeWid";
_r = (float) (_paneshape.getWidth()/(double)2+_mstrokewidth/(double)2);
 //BA.debugLineNum = 163;BA.debugLine="Dim sweepLength As Float = 90";
_sweeplength = (float) (90);
 //BA.debugLineNum = 164;BA.debugLine="Dim shapeArc As B4XPath";
_shapearc = new anywheresoftware.b4a.objects.B4XCanvas.B4XPath();
 //BA.debugLineNum = 165;BA.debugLine="shapeArc.InitializeArc(cx, cy, r, startangle, swe";
_shapearc.InitializeArc(_cx,_cy,_r,(float) (_startangle),_sweeplength);
 //BA.debugLineNum = 166;BA.debugLine="CanvasShape.DrawPath(shapeArc, HMITileUtils.COLOR";
_canvasshape.DrawPath(_shapearc,_hmitileutils._color_border_default /*int*/ ,__c.False,(float) (_mstrokewidth));
 //BA.debugLineNum = 167;BA.debugLine="Dim maskArc As B4XPath";
_maskarc = new anywheresoftware.b4a.objects.B4XCanvas.B4XPath();
 //BA.debugLineNum = 168;BA.debugLine="maskArc.InitializeArc(cx, cy, r - mStrokeWidth, s";
_maskarc.InitializeArc(_cx,_cy,(float) (_r-_mstrokewidth),(float) (_startangle),(float) (180));
 //BA.debugLineNum = 169;BA.debugLine="CanvasShape.DrawPath(maskArc, HMITileUtils.COLOR_";
_canvasshape.DrawPath(_maskarc,_hmitileutils._color_tile_normal_background /*int*/ ,__c.True,(float) (0));
 //BA.debugLineNum = 170;BA.debugLine="CanvasShape.Invalidate";
...
float _cx = 0f;
float _cy = 0f;
 //BA.debugLineNum = 131;BA.debugLine="Private Sub DrawLine(vertical As Boolean)";
 //BA.debugLineNum = 132;BA.debugLine="Dim x1 As Float";
_x1 = 0f;
 //BA.debugLineNum = 133;BA.debugLine="Dim y1 As Float";
_y1 = 0f;
 //BA.debugLineNum = 134;BA.debugLine="Dim x2 As Float";
_x2 = 0f;
 //BA.debugLineNum = 135;BA.debugLine="Dim y2 As Float";
_y2 = 0f;
 //BA.debugLineNum = 136;BA.debugLine="Dim cx As Float	= PaneShape.Width / 2";
_cx = (float) (_paneshape.getWidth()/(double)2);
 //BA.debugLineNum = 137;BA.debugLine="Dim cy As Float = PaneShape.Height / 2";
_cy = (float) (_paneshape.getHeight()/(double)2);
 //BA.debugLineNum = 139;BA.debugLine="If Not(vertical) Then";
if (__c.Not(_vertical)) { 
 //BA.debugLineNum = 140;BA.debugLine="x1 = 0";
_x1 = (float) (0);
 //BA.debugLineNum = 141;BA.debugLine="y1 = cy";
_y1 = _cy;
 //BA.debugLineNum = 142;BA.debugLine="x2 = PaneShape.Width";
_x2 = (float) (_paneshape.getWidth());
 //BA.debugLineNum = 143;BA.debugLine="y2 = cy";
_y2 = _cy;
 //BA.debugLineNum = 144;BA.debugLine="CanvasShape.DrawLine(x1,y1,x2,y2,HMITileUtils.CO";
_canvasshape.DrawLine(_x1,_y1,_x2,_y2,_hmitileutils._color_border_default /*int*/ ,(float) (_mstrokewidth));
 //BA.debugLineNum = 145;BA.debugLine="CanvasShape.Invalidate";
_canvasshape.Invalidate();
 }else {
 //BA.debugLineNum = 147;BA.debugLine="x1 = cx";
_x1 = _cx;
 //BA.debugLineNum = 148;BA.debugLine="y1 = 0";
_y1 = (float) (0);
 //BA.debugLineNum = 149;BA.debugLine="x2 = cx";
_x2 = _cx;
 //BA.debugLineNum = 150;BA.debugLine="y2 = PaneShape.Height";
_y2 = (float) (_paneshape.getHeight());
 //BA.debugLineNum = 151;BA.debugLine="CanvasShape.DrawLine(x1,y1,x2,y2,HMITileUtils.CO";
_canvasshape.DrawLine(_x1,_y1,_x2,_y2,_hmitileutils._color_border_default /*int*/ ,(float) (_mstrokewidth));
 //BA.debugLineNum = 152;BA.debugLine="CanvasShape.Invalidate";
_canvasshape.Invalidate();
 };
...
public String  _drawshape() throws Exception{
 //BA.debugLineNum = 108;BA.debugLine="Public Sub DrawShape";
 //BA.debugLineNum = 110;BA.debugLine="CanvasShape.ClearRect(CanvasShape.TargetRect)";
_canvasshape.ClearRect(_canvasshape.getTargetRect());
 //BA.debugLineNum = 112;BA.debugLine="Select mShapeType";
...
case 0: {
 //BA.debugLineNum = 114;BA.debugLine="DrawLine(False)";
_drawline(__c.False);
 break; }
case 1: {
 //BA.debugLineNum = 116;BA.debugLine="DrawLine(True)";
_drawline(__c.True);
 break; }
case 2: {
 //BA.debugLineNum = 118;BA.debugLine="DrawLine(False)";
_drawline(__c.False);
 //BA.debugLineNum = 119;BA.debugLine="DrawLine(True)";
_drawline(__c.True);
 break; }
case 3: {
 //BA.debugLineNum = 121;BA.debugLine="DrawCorner(PaneShape.Width, PaneShape.Height, 1";
_drawcorner((float) (_paneshape.getWidth()),(float) (_paneshape.getHeight()),(int) (180));
 break; }
case 4: {
 //BA.debugLineNum = 123;BA.debugLine="DrawCorner(PaneShape.Width, 0, 90)";
_drawcorner((float) (_paneshape.getWidth()),(float) (0),(int) (90));
 break; }
case 5: {
 //BA.debugLineNum = 125;BA.debugLine="DrawCorner(0, 0, 0)";
_drawcorner((float) (0),(float) (0),(int) (0));
 break; }
case 6: {
 //BA.debugLineNum = 127;BA.debugLine="DrawCorner(0, PaneShape.Height, 270)";
...
public boolean  _getenabled() throws Exception{
 //BA.debugLineNum = 101;BA.debugLine="Public Sub getEnabled As Boolean";
 //BA.debugLineNum = 102;BA.debugLine="Return mBase.Enabled";
...
public String  _setenabled(boolean _enabled) throws Exception{
 //BA.debugLineNum = 97;BA.debugLine="Public Sub setEnabled(enabled As Boolean)";
 //BA.debugLineNum = 98;BA.debugLine="mBase.Enabled = enabled";
_mbase.setEnabled(_enabled);
 //BA.debugLineNum = 99;BA.debugLine="HMITileUtils.SetAlpha(mBase.enabled)";
