...
public class hmitilegridhelper extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example.hmitilegridhelper");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.example.hmitilegridhelper.class).invoke(this, new Object[] {null});
        else
...
public String  _class_globals() throws Exception{
 //BA.debugLineNum = 22;BA.debugLine="Private Sub Class_Globals";
...
_mparent.AddView((android.view.View)(_gridpanel.getObject()),(int) (0),(int) (0),_mparent.getWidth(),_mparent.getHeight());
...
_gridcanvas.Initialize(_gridpanel);
...
_gridcanvas.DrawText(ba,_txt,(float) (_xi+__c.DipToCurrent((int) (2))),(float) (_yi+__c.DipToCurrent((int) (12))),_font,_majorcolor,BA.getEnumFromString(android.graphics.Paint.Align.class,"LEFT"));
 };
...
_gridpanel.SetLayoutAnimated((int) (0),(int) (0),(int) (0),_mparent.getWidth(),_mparent.getHeight());
 //BA.debugLineNum = 127;BA.debugLine="gridCanvas.Resize(mParent.Width, mParent.Heigh";
_gridcanvas.Resize((float) (_mparent.getWidth()),(float) (_mparent.getHeight()));
