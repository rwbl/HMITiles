...
public class b4xcache extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.b4xcache", this);
            if (htSubs == null) {
...
public b4j.example.b4xcache._b4xcacheitem  _createb4xcacheitem(Object _value,String _key) throws Exception{
...
_ci = (b4j.example.b4xcache._b4xcacheitem)(_data._get /*Object*/ ((Object)(_key)));
...
_data._remove /*String*/ ((Object)(((b4j.example.b4xcache._b4xcacheitem)(_values.Get(_i))).Key /*String*/ ));
 }
};
 };
