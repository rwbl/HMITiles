...
public class hmitileselect extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.hmitileselect", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", b4j.example.hmitileselect.class).invoke(this, new Object[] {null});
        else
...
public String  _add(Object _item) throws Exception{
 //BA.debugLineNum = 157;BA.debugLine="Public Sub Add(item As Object)";
 //BA.debugLineNum = 158;BA.debugLine="mItems.Add(item)";
_mitems.Add(_item);
...
Object _item = null;
 //BA.debugLineNum = 167;BA.debugLine="Public Sub AddAll(items As List)";
 //BA.debugLineNum = 168;BA.debugLine="If items.Size == 0 Then Return";
if (_items.getSize()==0) { 
if (true) return "";};
 //BA.debugLineNum = 169;BA.debugLine="For Each item As Object In items";
{
...
_item = group2.Get(index2);
 //BA.debugLineNum = 170;BA.debugLine="Add(item)";
_add(_item);
 }
};
 //BA.debugLineNum = 172;BA.debugLine="setSelectedIndex(0)";
...
public String  _afterloadlayout(anywheresoftware.b4a.objects.collections.Map _props) throws Exception{
 ...
 //BA.debugLineNum = 72;BA.debugLine="BasePane.LoadLayout(\"hmitileselect\")";
_basepane.LoadLayout("hmitileselect",ba);
...
_mshowtitle = BA.ObjectToBoolean(_props.Get((Object)("ShowTitle")));
 //BA.debugLineNum = 80;BA.debugLine="Base_Resize(BasePane.Width, BasePane.Height)";
...
public String  _applystyle() throws Exception{
 //BA.debugLineNum = 208;BA.debugLine="Private Sub ApplyStyle";
 //BA.debugLineNum = 209;BA.debugLine="HMITileUtils.ApplyTitleStyle(LabelTitle)";
_hmitileutils._applytitlestyle /*String*/ (_labeltitle);
 //BA.debugLineNum = 210;BA.debugLine="HMITileUtils.ApplyValueStyle(LabelSelected)";
_hmitileutils._applyvaluestyle /*String*/ (_labelselected);
 //BA.debugLineNum = 211;BA.debugLine="HMITileUtils.ApplyFontAwesomeStyle(LabelUp)";
_hmitileutils._applyfontawesomestyle /*String*/ (_labelup);
 //BA.debugLineNum = 212;BA.debugLine="HMITileUtils.ApplyFontAwesomeStyle(LabelDown)";
_hmitileutils._applyfontawesomestyle /*String*/ (_labeldown);
 //BA.debugLineNum = 214;BA.debugLine="PaneSelect.SetColorAndBorder(HMITileUtils.COLOR_T";
_paneselect.SetColorAndBorder(_hmitileutils._color_tile_normal_background /*int*/ ,__c.DipToCurrent((int) (0)),_hmitileutils._color_status_off_border /*int*/ ,__c.DipToCurrent((int) (0)));
 //BA.debugLineNum = 218;BA.debugLine="BasePane.Color = HMITileUtils.COLOR_TILE_NORMAL_B";
_basepane.setColor(_hmitileutils._color_tile_normal_background /*int*/ );
 //BA.debugLineNum = 220;BA.debugLine="BasePane.SetColorAndBorder(BasePane.Color, 0, 0,";
...
public String  _base_resize(double _width,double _height) throws Exception{
 ...
 //BA.debugLineNum = 87;BA.debugLine="If Not(LabelTitle.IsInitialized) Or Not(LabelUp.I";
...
if (true) return "";
 ...
 //BA.debugLineNum = 91;BA.debugLine="PaneSelect.SetLayoutAnimated	(0, 0, 				0, 					W";
_paneselect.SetLayoutAnimated((int) (0),0,0,_width,_height);
 //BA.debugLineNum = 92;BA.debugLine="LabelTitle.SetLayoutAnimated	(0, 0, 				0, 					W";
_labeltitle.SetLayoutAnimated((int) (0),0,0,_width,_height*0.25);
 //BA.debugLineNum = 93;BA.debugLine="LabelSelected.SetLayoutAnimated	(0, 0, 				LabelT";
_labelselected.SetLayoutAnimated((int) (0),0,_labeltitle.getHeight(),_width,_height*0.50);
 //BA.debugLineNum = 94;BA.debugLine="LabelDown.SetLayoutAnimated		(0, Width * 0.1,	Hei";
_labeldown.SetLayoutAnimated((int) (0),_width*0.1,_height*0.60,_width*0.3,_height*0.25);
 //BA.debugLineNum = 95;BA.debugLine="LabelUp.SetLayoutAnimated		(0, Width * 0.6, 	Heig";
...
_mcallback = new Object();
 //BA.debugLineNum = 34;BA.debugLine="Public BasePane As B4XView";
_basepane = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 35;BA.debugLine="Public BaseLabel As B4XView";
...
public String  _clear() throws Exception{
 //BA.debugLineNum = 191;BA.debugLine="Public Sub Clear";
 //BA.debugLineNum = 192;BA.debugLine="mItems.Clear";
_mitems.Clear();
 //BA.debugLineNum = 193;BA.debugLine="LabelSelected.Text = \"\"";
...
public String  _down() throws Exception{
 //BA.debugLineNum = 275;BA.debugLine="Private Sub Down";
 //BA.debugLineNum = 276;BA.debugLine="If mItems.Size == 0 Then Return";
if (_mitems.getSize()==0) { 
if (true) return "";};
 //BA.debugLineNum = 278;BA.debugLine="mSelectedIndex = mSelectedIndex - 1";
_mselectedindex = (int) (_mselectedindex-1);
 //BA.debugLineNum = 279;BA.debugLine="If mSelectedIndex < 0 Then";
if (_mselectedindex<0) { 
 //BA.debugLineNum = 280;BA.debugLine="mSelectedIndex = mItems.Size - 1";
_mselectedindex = (int) (_mitems.getSize()-1);
 };
 //BA.debugLineNum = 282;BA.debugLine="setSelectedIndex(mSelectedIndex)";
_setselectedindex(_mselectedindex);
 //BA.debugLineNum = 283;BA.debugLine="End Sub";
return "";
}
public boolean  _getenabled() throws Exception{
 //BA.debugLineNum = 117;BA.debugLine="Public Sub getEnabled As Boolean";
 //BA.debugLineNum = 118;BA.debugLine="Return BasePane.Enabled";
if (true) return _basepane.getEnabled();
 //BA.debugLineNum = 119;BA.debugLine="End Sub";
return false;
}
public String  _getselected() throws Exception{
 //BA.debugLineNum = 139;BA.debugLine="Public Sub getSelected As String";
 //BA.debugLineNum = 140;BA.debugLine="Return LabelSelected.Text";
if (true) return _labelselected.getText();
 //BA.debugLineNum = 141;BA.debugLine="End Sub";
return "";
}
public int  _getselectedindex() throws Exception{
 //BA.debugLineNum = 147;BA.debugLine="Public Sub getSelectedIndex As Int";
 //BA.debugLineNum = 148;BA.debugLine="Return mSelectedIndex";
if (true) return _mselectedindex;
 //BA.debugLineNum = 149;BA.debugLine="End Sub";
return 0;
}
public boolean  _getshowtitle() throws Exception{
 //BA.debugLineNum = 125;BA.debugLine="Public Sub getShowTitle As Boolean";
 //BA.debugLineNum = 126;BA.debugLine="Return mShowTitle";
if (true) return _mshowtitle;
 //BA.debugLineNum = 127;BA.debugLine="End Sub";
return false;
}
public String  _gettitle() throws Exception{
 //BA.debugLineNum = 109;BA.debugLine="Public Sub getTitle As String";
 //BA.debugLineNum = 110;BA.debugLine="Return LabelTitle.Text";
...
public String  _labeldown_mouseclicked(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 260;BA.debugLine="Private Sub LabelDown_MouseClicked (EventData As M";
 //BA.debugLineNum = 261;BA.debugLine="Down";
_down();
...
public String  _labelselected_mouseclicked(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 252;BA.debugLine="Private Sub LabelSelected_MouseClicked (EventData";
 //BA.debugLineNum = 253;BA.debugLine="ValueChanged";
_valuechanged();
...
public String  _labelup_mouseclicked(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 256;BA.debugLine="Private Sub LabelUp_MouseClicked (EventData As Mou";
 //BA.debugLineNum = 257;BA.debugLine="Up";
_up();
 //BA.debugLineNum = 258;BA.debugLine="End Sub";
return "";
}
public String  _plusminusselect_valuechanged(Object _value) throws Exception{
 //BA.debugLineNum = 229;BA.debugLine="Private Sub PlusMinusSelect_ValueChanged (Value As";
 //BA.debugLineNum = 231;BA.debugLine="If SubExists(mCallBack, mEventName & \"_ValueChang";
if (__c.SubExists(ba,_mcallback,_meventname+"_ValueChanged")) { 
 //BA.debugLineNum = 232;BA.debugLine="CallSub2(mCallBack, mEventName & \"_ValueChanged\"";
...
Object _objitem = null;
 //BA.debugLineNum = 179;BA.debugLine="Public Sub Remove(item As Object)";
 //BA.debugLineNum = 180;BA.debugLine="Dim index As Int = 0";
_index = (int) (0);
 //BA.debugLineNum = 181;BA.debugLine="For Each objitem As Object In mItems";
{
...
_objitem = group2.Get(index2);
 //BA.debugLineNum = 182;BA.debugLine="If objitem == item Then";
if ((_objitem).equals(_item)) { 
 //BA.debugLineNum = 183;BA.debugLine="mItems.RemoveAt(index)";
_mitems.RemoveAt(_index);
 //BA.debugLineNum = 184;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 186;BA.debugLine="index = index + 1";
_index = (int) (_index+1);
 }
};
...
public String  _setenabled(boolean _enabled) throws Exception{
 //BA.debugLineNum = 113;BA.debugLine="Public Sub setEnabled(enabled As Boolean)";
 //BA.debugLineNum = 114;BA.debugLine="BasePane.Enabled = enabled";
_basepane.setEnabled(_enabled);
 //BA.debugLineNum = 115;BA.debugLine="HMITileUtils.SetAlpha(BasePane.enabled)";
...
int _i = 0;
 //BA.debugLineNum = 129;BA.debugLine="Public Sub setSelected(item As String)";
 //BA.debugLineNum = 130;BA.debugLine="For i = 0 To mItems.Size - 1";
{
final int step1 = 1;
final int limit1 = (int) (_mitems.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit1 ;_i = _i + step1 ) {
 //BA.debugLineNum = 131;BA.debugLine="If mItems.Get(i) == item Then";
if ((_mitems.Get(_i)).equals((Object)(_item))) { 
 //BA.debugLineNum = 132;BA.debugLine="LabelSelected.Text = item";
_labelselected.setText(_item);
 //BA.debugLineNum = 133;BA.debugLine="mSelectedIndex = i";
_mselectedindex = _i;
 //BA.debugLineNum = 134;BA.debugLine="ValueChanged";
_valuechanged();
...
public String  _setselectedindex(int _index) throws Exception{
 //BA.debugLineNum = 143;BA.debugLine="Public Sub setSelectedIndex(index As Int)";
 //BA.debugLineNum = 144;BA.debugLine="mSelectedIndex = index";
_mselectedindex = _index;
 //BA.debugLineNum = 145;BA.debugLine="setSelected(mItems.Get(mSelectedIndex))";
...
public String  _setshowtitle(boolean _state) throws Exception{
 //BA.debugLineNum = 121;BA.debugLine="Public Sub setShowTitle(state As Boolean)";
 //BA.debugLineNum = 122;BA.debugLine="mShowTitle = state";
_mshowtitle = _state;
 //BA.debugLineNum = 123;BA.debugLine="Base_Resize(BasePane.Width, BasePane.Height)";
_base_resize(_basepane.getWidth(),_basepane.getHeight());
 //BA.debugLineNum = 124;BA.debugLine="End Sub";
return "";
}
public String  _settitle(String _text) throws Exception{
 //BA.debugLineNum = 106;BA.debugLine="Public Sub setTitle(text As String)";
 //BA.debugLineNum = 107;BA.debugLine="LabelTitle.Text = text";
_labeltitle.setText(_text);
 //BA.debugLineNum = 108;BA.debugLine="End Sub";
return "";
}
public int  _size() throws Exception{
 //BA.debugLineNum = 197;BA.debugLine="Public Sub Size As Int";
 //BA.debugLineNum = 198;BA.debugLine="Return mItems.Size";
if (true) return _mitems.getSize();
 //BA.debugLineNum = 199;BA.debugLine="End Sub";
return 0;
}
public String  _up() throws Exception{
 //BA.debugLineNum = 265;BA.debugLine="Private Sub Up";
 //BA.debugLineNum = 266;BA.debugLine="If mItems.Size == 0 Then Return";
if (_mitems.getSize()==0) { 
if (true) return "";};
 //BA.debugLineNum = 268;BA.debugLine="mSelectedIndex = mSelectedIndex + 1";
_mselectedindex = (int) (_mselectedindex+1);
 //BA.debugLineNum = 269;BA.debugLine="If mSelectedIndex > mItems.Size - 1 Then";
if (_mselectedindex>_mitems.getSize()-1) { 
 //BA.debugLineNum = 270;BA.debugLine="mSelectedIndex = 0";
_mselectedindex = (int) (0);
 };
 //BA.debugLineNum = 272;BA.debugLine="setSelectedIndex(mSelectedIndex)";
_setselectedindex(_mselectedindex);
 //BA.debugLineNum = 273;BA.debugLine="End Sub";
return "";
}
public String  _valuechanged() throws Exception{
 //BA.debugLineNum = 285;BA.debugLine="Private Sub ValueChanged";
 //BA.debugLineNum = 286;BA.debugLine="If mItems.Size == 0 Then Return";
if (_mitems.getSize()==0) { 
if (true) return "";};
 //BA.debugLineNum = 288;BA.debugLine="If SubExists(mCallBack, mEventName & \"_ValueChang";
if (__c.SubExists(ba,_mcallback,_meventname+"_ValueChanged")) { 
 //BA.debugLineNum = 289;BA.debugLine="CallSub2(mCallBack, mEventName & \"_ValueChanged\"";
