...
* NEW: Examples GetStarted - HMITileSeekBar, HMITileStatusIndicators, HMITileSelect, HMITileSelectList, HMITileList, HMITileGauge, HMITileTrend, HMITileEventsViewer, HMITileSensor, HMITileReadout, HMITileSPPV, HMITileTimer
